...
scratchpads = [
    ScratchPad("scratchpad", [
        ...
        DropDown("web", "firefox https://chat.openai.com https://bard.google.com https://messenger.com https://2027a.net/m/notes",
        ...
        DropDown("ranger", "kitty -e ranger", x=0.15, y=0.06, height=0.85,
                 width=0.7, opacity=1, on_focus_lost_hide=False),
        DropDown("thunar", "thunar", x=0.15, y=0.06, height=0.85,
                 width=0.7, opacity=1, on_focus_lost_hide=False),
    ],
               single=True,
               ),
